...
CREATE TABLE App (id BIGSERIAL NOT NULL, UserUUID varchar(30) NOT NULL, Name varchar(100) NOT NULL, IconUrl varchar(255), Description varchar(1000), Price numeric(10, 2) NOT NULL, Active bool NOT NULL, Version varchar(20) NOT NULL, WhatIsNew varchar(500), LastUpdate date NOT NULL, NumberOfDownloads int4 NOT NULL, Certified bool NOT NULL, PRIMARY KEY (id), CONSTRAINT AppName UNIQUE (Userid, Name));
CREATE TABLE Rating (AppUUID int8 NOT NULL, UserUUID varchar(30) NOT NULL, RatingValue int2 NOT NULL, Review varchar(1000), "Date" date NOT NULL, CONSTRAINT Const_AppAttribute_1 UNIQUE (AppUUID, UserUUID));
...
CREATE TABLE AppAttachment (AppUUID int8 NOT NULL, LocationUrl varchar(255) NOT NULL, Description varchar(255), Type int2 NOT NULL);
...
CREATE TABLE TechnicalDetails (AppUUID int8 NOT NULL, AttributeName varchar(100) NOT NULL, AttributeValue varchar(100) NOT NULL);
...
ALTER TABLE Rating ADD CONSTRAINT FKRating454146 FOREIGN KEY (AppUUID) REFERENCES App (id);
ALTER TABLE QAConversation ADD CONSTRAINT FKQAConversa118783 FOREIGN KEY (AppId) REFERENCES App (id);
ALTER TABLE AppAttachment ADD CONSTRAINT FKAppAttachm693886 FOREIGN KEY (AppUUID) REFERENCES App (id);
...
ALTER TABLE App ADD CONSTRAINT FKApp836197 FOREIGN KEY (Userid) REFERENCES "user" (UUID);
...
ALTER TABLE TechnicalDetails ADD CONSTRAINT FKTechnicalD509142 FOREIGN KEY (AppUUID) REFERENCES App (id);
